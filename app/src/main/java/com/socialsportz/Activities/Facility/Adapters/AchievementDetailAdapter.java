...
public class AchievementDetailAdapter extends RecyclerView.Adapter<AchievementDetailAdapter.MyViewHolder> {
    ...
    public AchievementDetailAdapter(Context context, List<FacAchievement> list, clickInterface listener ) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AchievementDetailAdapter.MyViewHolder holder, int position) {
        ...
        popup.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                ...
                case R.id.action_delete:
                    //handle menu2 click
                    listener.onDelete(achievement,pos);
                    break;
            }
            return false;
        });
...
*/
    ...
    public interface clickInterface{
        ...
        void onDelete(FacAchievement achievement, int pos);
    }
