...
public class BatchSlotAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BatchSlotAdapter(Context context, CopyOnWriteArrayList<BatchSlot> data, onClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == 1) {
            View layoutView = LayoutInflater.from(context)
                    .inflate(R.layout.batch_slot_design, parent, false);
    ...
    class myViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView sportName,stDate,edDate, typeTag,maxBook,price,tv_status;
