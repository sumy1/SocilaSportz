...
public class FacSportAdapter extends RecyclerView.Adapter<FacSportAdapter.MyViewHolder> {
    ...
    public FacSportAdapter(Context context, List<FacSport> list, onClickInterface listener) {
