...
public class AddAcaBatchDialogFragment extends DialogFragment implements View.OnClickListener {

	private final static String TAG = AddAcaBatchDialogFragment.class.getSimpleName();
	private int facId;
	private int sportId;
	...
	public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_dialog_add_batch, container, false);
