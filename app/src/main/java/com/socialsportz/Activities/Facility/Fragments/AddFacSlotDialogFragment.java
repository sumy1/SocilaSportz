...
public class AddFacSlotDialogFragment extends DialogFragment implements View.OnClickListener {

	private static final String TAG = AddFacSlotDialogFragment.class.getSimpleName();
	private int facId;
	...
	public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_dialog_add_slot, container, false);
