...
public class CoreBookingFragment extends Fragment {
	...
	private void addFragments() {
		mFragments.clear();
		mFragments.add(0, new SportBookingFragment());
		mFragments.add(1, new BookingFragment());
	...
	private class MyPagerAdapter extends FragmentPagerAdapter {
		...
		MyPagerAdapter(FragmentManager fm, ArrayList<Fragment> list) {
			super(fm);
			this.list = list;
			this.pages = Utils.getBookingTitles();
		}
	...
	public void setData() {
		...
		try {
			...
			SportBookingFragment.facidd=facId;
			BookingFragment.faciddd=facId;
