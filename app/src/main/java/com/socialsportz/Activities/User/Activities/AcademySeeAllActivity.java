...
import com.socialsportz.Activities.User.Adapters.AcademySeeAllAdapter;
...
public class AcademySeeAllActivity extends AppCompatActivity {

	private static final String TAG =NotificationActivity.class.getSimpleName() ;
	private Context context;
	private RecyclerView rv_myEnquire;
	private LinearLayoutManager mLayoutManager;
	private AcademySeeAllAdapter userNotificationAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_academy_see_all);
	...
	private void setRecyclerView(CopyOnWriteArrayList<UserFacAca> userEnquires){
		userNotificationAdapter = new AcademySeeAllAdapter(context, userEnquires);
