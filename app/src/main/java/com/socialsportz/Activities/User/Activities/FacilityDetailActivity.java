...
public class FacilityDetailActivity extends AppCompatActivity implements DashFacilityAdapter.onItemClickListener, OnMapReadyCallback {
	private static final String TAG = FacilityDetailActivity.class.getSimpleName();
	private Intent i;
	...
	int fav_id;
	UserReviewFragment fragment2;
	TabLayoutAdapter adapter;
    NestedScrollView viweNested;
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		setStatusBarGradient(FacilityDetailActivity.this);
		...
		findViewById(R.id.fab).setOnClickListener(v -> {
			...
			Log.d("FD", userFacAca.getFacId() + "/" + fac_type + "/" + SportName + "/" + SportId + userFacAca.getFacName());
			Intent in = new Intent(FacilityDetailActivity.this, UserCalaenderBookingActivity.class);
	...
	public void initViews() {
		...
		Log.d("rating", userFacAca.getRating() + "/" + userFacAca.getRatingAvg());
		...
		viweNested=findViewById(R.id.viweNested);
		...
		if (userFacAca.getRatingAvg().equalsIgnoreCase("0")) {
			...
			tv_review.setText(userFacAca.getRating() + " Reviews");
		}
...
//                    ch_favorite.setBackground();
	...
	private void initData() {
		...
		//tabLayout.setTabGravity(TabLayout.GRAVITY_FILL);
		 ...
		 adapter = new TabLayoutAdapter(this, getSupportFragmentManager(), tabLayout.getTabCount(), userFacAca);
