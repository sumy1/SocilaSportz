...
import com.socialsportz.Activities.User.Adapters.UserEnquireAdapter;
...
public class MyEnquireActivity extends AppCompatActivity {

    private static final String TAG =NotificationActivity.class.getSimpleName() ;
    private Context context;
    private RecyclerView rv_myEnquire;
    private LinearLayoutManager mLayoutManager;
    private UserEnquireAdapter userNotificationAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_enquire);

        loaderView = CustomLoaderView.initialize(MyEnquireActivity.this);
        context=this;
    ...
    private void setRecyclerView(){
        CopyOnWriteArrayList<UserEnquire> userEnquires = new CopyOnWriteArrayList<>();
        userNotificationAdapter = new UserEnquireAdapter(context, userEnquires);
