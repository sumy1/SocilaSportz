...
public class FacilityAmenityAdapter extends RecyclerView.Adapter<FacilityAmenityAdapter.myViewHolder>{
    private Context context;
    private CopyOnWriteArrayList<Amenity> mData;
    private ItemClickListener listener;

    public FacilityAmenityAdapter(Context context, CopyOnWriteArrayList<Amenity> data, ItemClickListener listener) {
