...
public class ViewGallaryAdapter extends RecyclerView.Adapter<ViewGallaryAdapter.myViewHolder> {
    private Context context;
    private CopyOnWriteArrayList<UserFacViewGallery> mData;
    /*private onItemClickListener listener;*/
	ViewGallaryAdapter viewGallaryAdapter;
	Dialog dialog;
	String newImage,folder;


    public ViewGallaryAdapter(Context context, CopyOnWriteArrayList<UserFacViewGallery> mData) {
    ...
    public void onBindViewHolder(@NonNull myViewHolder myViewHolder, int position) {
        ...
        UserFacViewGallery viewGallery = mData.get(position);
	...
	private void CongratsDialog(String folderName,String galleryImage){
		...
		ViewGallaryAdapterr viewGallaryAdapter = new ViewGallaryAdapterr(context, mData, new ViewGallaryAdapterr.onItemClickListener() {
			@Override
