...
public class ViewGallaryAdapterr extends RecyclerView.Adapter<ViewGallaryAdapterr.myViewHolder> {
   ...
   private onItemClickListener listener;
    ...
    public ViewGallaryAdapterr(Context context, CopyOnWriteArrayList<UserFacViewGallery> mData,onItemClickListener listener) {
