package com.socialsportz.Broadcast;
...
public class ReachableManager extends BroadcastReceiver {
	...
	private static ReachableManager _ReachableManager;
	public static ConnectivityReceiverListener _ConnectivityReceiverListener;

	public ReachableManager(){
		super();
		IntentFilter filter = new IntentFilter();
		filter.addAction("CONNECTIVITY_CHANGE");
	}

	public static synchronized ReachableManager reachabilityManager (){
		if(_ReachableManager == null) {
			_ReachableManager = new ReachableManager();
		}
	...
	private static boolean isConnectedWifi(Context context){
		NetworkInfo info = ReachableManager.getNetworkInfo(context);
	...
	/**
	 * Check if there is any connectivity to a fast network
	 */
	private static boolean isConnectedFast(Context context){
		NetworkInfo info = ReachableManager.getNetworkInfo(context);
		return (info != null && info.isConnected() && ReachableManager.isConnectionFast(info.getType(),info.getSubtype()));
	}
	...
	public static boolean getNetworkStatus() {
		...
		NetworkInfo activeNetwork = ReachableManager.getNetworkInfo(context);
