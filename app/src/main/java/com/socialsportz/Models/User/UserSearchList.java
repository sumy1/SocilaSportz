...
public class UserSearchList extends BaseModel implements Serializable {
    ...
    public UserSearchList(JSONObject jsonResponse){
        this.facId = getValue(jsonResponse, kFacId, String.class);
        this.userId =getValue(jsonResponse, kUserId, String.class);
        ...
        try {
            this.rating = (int) jsonResponse.get(kRatingCount);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        this.ratingAvg = getValue(jsonResponse,kRatingAverage,String.class);
        try {
            this.isFav = (int) jsonResponse.get(kIsFavorite);
        } catch (JSONException e) {
            e.printStackTrace();
        }
    ...
    public UserSearchList(String id, int image) {
        this.facId = id;
        this.image = image;
        this.facBannerImg = "";
    }
