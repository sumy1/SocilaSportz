...
class Cms extends CI_Controller {
   ...
   public function excelstaticpage(){
	$order_by = array('col_name'=>'page_id','order'=>'desc');
    $data['staticdata'] = $this->CommonMdl->getResultOrderBy('tbl_static_page','*',$order_by);
	$this->load->view('admin/static-page/StaticExcel/StaticExcelView',$data);
   }
