				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						   <div class="row">
									...
									<?php echo form_open_multipart('admin/facility/facbatchbookinglist',array('class'=>'form-horizontal')); ?>
							...
							<?php endif;?>
									<div class="col-xs-12">
										...
										<div class="table-header">
											...
											<form method="post" action="<?=base_url('admin/facility/exportbatchbooking');?>" id="excel_export">
