...
//print_data($this->session->userdata());    
  checkUserRole();
if($this->session->userdata('user_roles')){
...
$data['accessList'] = $this->CommonMdl->getResult('tbl_admin_post','*');
// print_data($data['accessList']);
...
public function changeuserstatus(){
 ...
 public function useredit($id){
   ...
   public function userupdate(){
      ...
      if($result==true)
          {
                    $this->session->set_flashdata('msg','User updated sucesfully');
                    $this->session->set_flashdata('msg_class','bg-success');
