				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Slot Booking  List</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						   <div class="row">
									...
									<a href="<?=base_url('admin/facility/facbookinglist');?>"  class="btn btn-info clearbtn" id="clearbtn">
							...
							<?php endif;?>
									<div class="col-xs-12">
										...
										<div class="table-header">
											...
											<form method="post" action="<?=base_url('admin/facility/exportslotbooking');?>" id="excel_export">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<td><?=$faclinkbookingVal->name;?></td>
                                                       ...
                                                       <td><?=ucfirst($faclinkbookingVal->fac_type);?></td>
