				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Batch Booking  List</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						   <div class="row">
									...
									<?php echo form_open_multipart('admin/facility/factrialbookinglist',array('class'=>'form-horizontal')); ?>
									...
									<?php echo form_submit(['class'=>'btn btn-info ordersmall','name'=>'Submit','id'=>'batch_submit','value'=>'Submit']); ?>
							...
							<?php endif;?>
									<div class="col-xs-12">
										...
										<div class="table-header">
											...
											<form method="post" action="<?=base_url('admin/facility/exportbatchtrialbooking');?>" id="excel_export">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<td><?=$faclinkbookingVal->name;?></td>
                                                       ...
                                                       <td><?=$faclinkbookingVal->fac_name;?></td>
                                                       <td><?=$faclinkbookingVal->fac_type;?></td>
                                                       ...
                                                       <td><?=date('d-m-Y',strtotime($faclinkbookingVal->created_on));?></td>
...
$(document).ready(function(){		
	$(document).on('click','#batch_submit',function(){
...
var facilty_slot_data=document.querySelector('#facilty_slotydata');
		 facilty_slot_data.addEventListener('click',function(){
		  ...
		  document.getElementById('booking_types').value=booking_type; 
		  $('#excel_export').submit();		
		 });
