				...
				<div class="main-content">
					...
					<div class="main-content-inner">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= base_url('admin/facility');?>">User (Owner) List</a>
							</li>
						...
						<div class="alert <?=$msg_class;?> alert-dismissible mb-2" id="msg_show" role="alert"><?=$msg;?> </div>
							...
							<?php endif;?>	
								<div class="col-md-12">
									...
									<?php echo form_open_multipart('admin/facility/facilityeditowner',array('class'=>'form-horizontal')); ?>
										...
										<div class="col-md-6">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-9">
													 ...
													 <?php echo form_input(array('name'=>'is_email_verified','id'=>'is_email_verified','class'=>'col-xs-12','Placeholder'=>'User Email','value'=>ucfirst($user_edit[0]->is_email_verified),'readonly'=>'yes')); ?>
 ...
 */
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
												<?php echo form_input(array('name'=>'is_mobile_verified','id'=>'is_mobile_verified','class'=>'col-xs-12','Placeholder'=>'Is mobile verified','value'=>$user_edit[0]->is_mobile_verified,'readonly'=>'yes')); ?>
                         ...
                         <!--
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="col-md-3 control-label no-padding-right" for="form-field-1"> User Role</label>
												<div class="col-md-9">
												
												
												<select name="user_rol" class="form-control"disabled>
													 <option value="1">End user</option>
													 <option value="2"selected>Academy / Facility</option>
						...
						<div class="col-md-6">
                            		...
                            		<div class="col-sm-9">									
									  ...
									  <select name="user_status" class="form-control"> 
														...
														<option value="disable" <?php if($user_edit[0]->user_status=="disable") echo "selected"?>>Inactive</option>
