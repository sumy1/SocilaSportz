						...
						<!-- Normal Purchase -->
							...
							<div class="row">
								...
								?>
								  ...
								  ?>
											<td><?=trim($val->batch_slot_start_time);?></td>
								...
								<tr>
										 ...
										 <td><strong>₹ <?=$fac_booking_listing->total_amount;;?></strong></td>
										 </tr>
								<tr>
									<td colspan="7"></td>
									      <td><strong>Coupon Code</strong></td>
									     <td><?=$fac_booking_listing->coupon_code;?></td>
									     </tr>
										 <tr>
										 	<td colspan="7"></td>
										 <td><strong>Discount Amount</strong></td>
										 <td><strong>₹ <?=$fac_booking_listing->discount_amount	;?></strong></td>
										 </tr>
										 
										 <tr>
										 	<td colspan="7"></td>
										 <td><strong>Final Amount</strong></td>
									     <td><strong>₹ <?=$fac_booking_listing->final_amount;?></strong></td>
