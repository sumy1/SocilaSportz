            ...
            <div class="main-content">
				...
				<?php endif;?>	
							...
							<div class="col-md-12">
                                ...
                                echo form_open_multipart('admin/home/add_sport',array('class'=>'form-horizontal')); ?>
                              ...
                              <div class="row">
											...
											<div class="form-group">
												...
												<div class="col-md-10">
                                                     <select name="sport_id" class="col-xs-12">
													   
													    <?php if(isset($sport_data) && !empty($sport_data)){foreach($sport_data as $sport_datas){?>
														     <option value="<?=$sport_datas->sport_id ?>"><?=$sport_datas->sport_name ?></option>
                             ...
                             //Edit banner
								...
								echo form_open_multipart('admin/home/edit_sport',array('class'=>'form-horizontal')); ?>
								  ...
								  <div class="row">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													    ...
													    <?php if(isset($sport_data) && !empty($sport_data)){foreach($sport_data as $sport_datas){?>
														     <option value="<?=$sport_datas->sport_id ?>" <?php
															   if( $sport_datas->sport_id == $edit_sport[0]->sport_id) echo "selected"
															 
															 ?>>
															 <?=$sport_datas->sport_name ?></option>
										...
										<input type="hidden" id="home_sport_id" name="home_sport_id" value="<?=$edit_sport[0]->home_sport_id;?>" />

										<input type="hidden" id="old_icon_image" name="old_icon_image" value="<?=$edit_sport[0]->icon_image;?>" />

										<?php if($edit_sport[0]->icon_image!=''){ ?>
										<img src="<?=base_url('assets/admin/images/home/'.$edit_sport[0]->icon_image);?>" height="50px" width="50px">
										<?php } ?>
											...
											<div class="form-group">
												...
												<img src="<?=base_url('assets/admin/images/home/'.$edit_sport[0]->sport_image);?>" height="50px" width="50px">
												<?php } ?>
                        	...
                        	<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<?php if(isset($alldata) && !empty($alldata)){ $i=1 ;foreach($alldata as $result){?>
													...
													<tr>
														...
														<td><a><?php echo $result->sport_names[0]->sport_name; ?></a></td>

													<td><img src="<?php echo base_url(); ?>assets/admin/images/home/<?php echo $result->icon_image; ?>" height="50px" width="50px" /></td>
													<td><img src="<?php echo base_url(); ?>assets/admin/images/home/<?php echo $result->sport_image; ?>" height="50px" width="50px" /></td>
														...
														<td>
															...
															<a class="green" href="<?php echo base_url('admin/home/sport/'.$result->home_sport_id); ?>">

																	<i class="ace-icon fa fa-pencil bigger-130"></i>

																</a>

																<a class="red" href="<?php echo base_url('admin/home/delete_sport/'.$result->home_sport_id); ?>" onclick="return confirm('Are you sure you want to delete sport')">
