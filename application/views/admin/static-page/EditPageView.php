						...
						<div class="alert <?=$msg_class;?> alert-dismissible mb-2" id="msg_show" role="alert"><?=$msg;?> </div>
							...
							<?php endif;?>	
								<div class="col-md-12">
									...
									<?php echo form_open_multipart('admin/cms/update_page',array('class'=>'form-horizontal')); ?>
									...
									<div class="row">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													...
													<?php echo form_input(array('name'=>'page_name','id'=>'page_name','class'=>'col-xs-12','Placeholder'=>'page title','value'=>$edit_page[0]->page_title )); ?>
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													...
													<?php echo form_input(array('name'=>'page_slug','id'=>'page_slug','class'=>'col-xs-12','Placeholder'=>'Page Slug','value'=>$edit_page[0]->page_slug)); ?>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-md-9">
													...
													<?php echo form_textarea(array('name'=>'first_section','id'=>'first_section','class'=>'col-xs-10 col-sm-10','Placeholder'=>'First Section', 'value'=>$edit_page[0]->first_section)); ?>
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													...
													<?php echo form_textarea(array('name'=>'second_section','id'=>'second_section','class'=>'col-xs-10 col-sm-10','Placeholder'=>'Second Section', 'value'=>$edit_page[0]->second_section)); ?>
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													...
													<?php echo form_textarea(array('name'=>'third_section','id'=>'third_section','class'=>'col-xs-10 col-sm-10','Placeholder'=>'Third Section', 'value'=>$edit_page[0]->third_section)); ?>
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													...
													<?php echo form_textarea(array('name'=>'page_meta','id'=>'page_meta','class'=>'col-xs-10 col-sm-10','Placeholder'=>'Page Meta', 'value'=>$edit_page[0]->page_meta)); ?>
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													...
													<input type="hidden" id="old_page_banner" name="old_page_banner" value="<?=$edit_page[0]->page_banner;?>">
													<input type="hidden" id="page_id" name="page_id" value="<?=$edit_page[0]->page_id;?>">
													<?php if($edit_page[0]->page_banner!=''){ ?>
										<img src="<?=base_url('assets/public/images/cms/'.$edit_page[0]->page_banner);?>" height="50px" width="50px">
										<?php } ?>
                            		...
                            		<div class="col-sm-9">									
                            			...
                            			<label class="middle">
                            						...
                            						<?php
                            				 if($edit_page['0']->page_status=='enable'){  
