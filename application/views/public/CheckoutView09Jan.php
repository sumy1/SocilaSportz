                                    ...
                                    <div class="c-right-body">
												...
												<?php 
                                                    ...
                                                    <tr>
                                                        <td class="ch-prod-name">
                                                            ...
                                                            <?php if($fac_details->fac_type=='academy'){?>
                                                            <td class="ch-prod-name">
                                                            <h3> <?php echo $listVal->package_name; ?></h3></td>
                                                            <?php } ?>
                                                            <td class="ch-prod-name">
                                                            <h3> <?php echo date('d-m-Y',strtotime($listVal->book_date));?></h3></td>
                                                        <td class="ch-prod-price"><i class="fa fa-inr"></i> <?php echo $listVal->slot_package_price; ?></td>
                                      ...
                                      <div class="col-sm-12 couponwrapper">
                                                    <input type="text" class="coupon_code" placeholder="Coupon Code">
                                                        <button class="btn btn-info applycouponbtn" id="applybtn">Apply</button>
