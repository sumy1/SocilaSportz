                                ...
                                <div class="checkout-right btn-pay">
                                    ...
                                    <div class="c-right-body">
                                      ...
                                      <div class="col-sm-12 headingorangenext">
                                        ...
                                        <form method="post" action="<?=base_url('booking/event_booking_now');?>">
                                       <div class="row bookingrow">
                                        ...
                                        <div class="col-sm-6 text-right" style="padding-right: 26px;padding-top: 10px">
                                         <strong><i class="fa fa-inr"></i> <span class="total_price"><?php echo $event_details->event_price; ?></span></strong>
                                        </div>
                                        ...
                                        <table style="width:100%;" cellpadding="0" cellspacing="0">
                                            ...
                                            <tfoot class="final-box">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="total-font text-right total1" style="padding-top:0px" colspan="3" id="total1"><i class="fa fa-inr"></i> <span class="final_amt"><?php echo $event_details->event_price; ?></span></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="5">
