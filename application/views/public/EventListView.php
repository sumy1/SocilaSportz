...
<body id="searchfacilityacademy">
    ...
    <section class="search-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
                    <h3><span id="total_count"> <?php if(isset($event_data_count)) { echo $event_data_count; } ?></span> results found</h3>
                </div>
			...
			<div class="searchfilterwrapper">
				<div class="row">
				 ...
				 <div class="col-sm-6 text-right">
				 	<?php if(!empty($this->session->userdata('usercity'))){ ?>
					<i class="fa fa-map-marker"></i> <?php  echo $this->session->userdata('usercity'); } ?>
				 </div>               
				</div>
			</div>
			...
			<div class="row">
                <div class="col-sm-12">
					...
					<?php 
					if(!empty($event_data)) { 
						foreach($event_data as $eventVal){ /* print_data($eventVal); */?>
                        <div class="col-sm-4">
                            ...
                            <div class="row">
                               ...
                               if($count < $eventVal->event_max_capicity_per_day && $eventVal->application_end_date >= date('Y-m-d') && $eventVal->application_start_date <= date('Y-m-d')){ ?>
                                <div class="row">
