																...
																<div class="cus_modal_body">
																	<div class="details_box mt-1">
																		<div class="row">
																			...
																			<div class="col-md-4">
																				<?php if($bank_detail && $bank_detail->admin_approval=='disapproved'){?>
																				<a href="javascript:void(0)">
																					<div class="profile_status_rib1 clearfix" id="rejected_popup"><p class="status1 pending"><i class="fa fa-clock-o"></i> Rejacted</p>
																						<h5>Bank Details</h5>
																					</div>
																				</a>
																				<?php } elseif($bank_detail && $bank_detail->admin_approval=='approved'){?>
																				<div class="profile_status_rib1 clearfix">
																				<p class="status1 completed"><i class="fa fa-check"></i> Completed</p>
																				<h5>Bank Details</h5>
																			</div>
																				<?php }
																				 elseif($bank_detail && $bank_detail->admin_approval=='void') { ?>
																				<div class="profile_status_rib1 clearfix">
																				<p class="status1 pending"><i class="fa fa-check"></i> Pending</p>
																				<h5>Bank Details</h5>
																			</div>
																				<?php } else{ ?>
																				<div class="profile_status_rib1 clearfix">
																				<p class="status1 pending"><i class="fa fa-check"></i> Not Found</p>
																				<h5>Bank Details</h5>
																			</div><?php  } ?>
																			</div>
																			<div class="col-md-4">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group bmd-form-group bmd-form-group-sm">
										...
										<input type="hidden" class="form-control" id="latitude" value="<?php if($fac_personal_data) echo $fac_personal_data->user_latitude;?>">
										<input type="hidden" class="form-control" id="longitude" value="<?php if($fac_personal_data) echo $fac_personal_data->user_longitude;?>">
										<i class="fa fa-map-marker prefix"></i>
...
<script>
				...
				if(res!='failed'){
					swal({
						...
						if (result.value) {
							...
							// window.location.href= '<?=base_url('dashboard/accountinfo');?>';
						}
					})
				}
				else{
	...
	setTimeout(function(){cdf = jQuery(".completedprofile").text();
		if( cdf > 49 ){jQuery(".progress-bar").addClass('almostcomplete')}
...
<script>
	...
	var addressInputElement = $('#userAddress');
...
/*
	setInterval(function(){
		jQuery("#userAddress").removeAttr("placeholder");
	},100);
