										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group bmd-form-group">
													<label for="facilityname1" class="bmd-label-floating">Facility Name</label>
													<input type="text" class="form-control" name="facilityname" id="facilityname1">	<i class="fa fa-university prefix"></i>
											...
											<div class="col-md-12">
												<div class="form-group bmd-form-group">
													...
													<textarea id="textacademy" name="fac_text"></textarea>	<i class="fa fa-file-text prefix" aria-hidden="true"></i>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group bmd-form-group">
														...
														<input type="text" class="form-control charval" name="fac_city" id="facilitycity">	<i class="fa fa-map-marker prefix"></i>
												...
												<div class="col-md-4">
													<div class="form-group bmd-form-group">
														...
														<input type="text" class="form-control" name="fac_area" id="facilityarea">	<i class="fa fa-map-marker prefix"></i>
