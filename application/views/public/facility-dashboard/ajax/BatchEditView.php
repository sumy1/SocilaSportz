            ...
            <div class="row" id="editacademyplan">
                ...
                <div class="col-md-3">
                    <div class="form-group bmd-form-group is-filled" style="margin-top: 5px;">
                        ...
                        <span id="errPlans" class="error"></span>    
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group bmd-form-group">
                        ...
                        <span id="errsSlotprices" class="error"> </span>
                    </div>
                </div>
...
<script>
    ...
    $('#fac_batch_update').on("click",function(event) {
		...
		var academybatchpriceedit= $(".rowparent").length;
...
if(max_participanets == ''){
	...
	if(academybatchpriceedit<=0){
        $('#errPlans').show();
        $('#errPlans').html('Please add at least one Plan');
