...
<form action="" class="sm_inputs" name="achievement_info_edit" id="achievement_info_edit" enctype="multipart/form-data">
	<div class="row">
		...
		<div class="col-md-6 mt-3 reward_1">
			...
			<input type="hidden" class="old_image" id="old_image1" name="old_image1" value="<?=$fac_achievement->image1;?>">
	...
	$(document).on("click","#successAcheiveUpdatebtn" , function(event) {
		...
		if(image1=='' && old_image1 == ''){
				  $('#errorimage_1').html('Please attach one image');
				  return false;
			  }else{
				  $('#errorimage_1').html('');
			  }
