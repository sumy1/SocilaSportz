        ...
        <div class="col-sm-12">
            <ul class="list-inline list_upload_img">
                <li class="list-inline-item">
                     <?php if($fac_bank){ $gstext=explode('.',$fac_bank->gst_image); }  ?>
                    <input type="file" id="input-file-bank-gst" class="dropify" name="gst_image" data-default-file="<?php if($fac_bank && count($gstext)>1 && $gstext[1]!='pdf') echo base_url('assets/public/images/bankinfo/'.$fac_bank->gst_image); else if($fac_bank && count($gstext)>1 && $gstext[1]=='pdf') echo base_url('assets/public/images/pdf.png') ?>" />
                ...
                <li class="list-inline-item">
                    ...
                    <input type="file" id="input-file-bank-pan" class="dropify" name="pan_image" data-default-file="<?php if($fac_bank && count($panext)>1 && $panext[1]!='pdf') echo base_url('assets/public/images/bankinfo/'.$fac_bank->pan_image); else if($fac_bank && count($panext)>1 && $panext[1]=='pdf') echo base_url('assets/public/images/pdf.png') ?>" />
                ...
                <li class="list-inline-item">
                    ...
                    <input type="file" id="input-file-bank-registration" class="dropify" name="firm_image" data-default-file="<?php if($fac_bank  && count($firmext)>1 && $firmext[1]!='pdf') echo base_url('assets/public/images/bankinfo/'.$fac_bank->firm_image); else if($fac_bank  && count($firmext)>1 && $firmext[1]=='pdf') echo base_url('assets/public/images/pdf.png')?>" />
                ...
                <li class="list-inline-item">
                    ...
                    <input type="file" id="input-file-bank-addprf" class="dropify" name="address_proof_image" data-default-file="<?php if($fac_bank && count($addressext)>1 && $addressext[1]!='pdf') echo base_url('assets/public/images/bankinfo/'.$fac_bank->address_proof_image); else if($fac_bank && count($addressext)>1 && $addressext[1]=='pdf') echo base_url('assets/public/images/pdf.png')?>" />
                ...
                <li class="list-inline-item">
                    ...
                    <input type="file" id="input-file-bank-cancheque" class="dropify" name="cheque_image" data-default-file="<?php if($fac_bank && count($chequeext)>1 && $chequeext[1]!='pdf') echo base_url('assets/public/images/bankinfo/'.$fac_bank->cheque_image); else if($fac_bank && count($addressext)>1 && $chequeext[1]=='pdf') echo base_url('assets/public/images/pdf.png')?>" />
