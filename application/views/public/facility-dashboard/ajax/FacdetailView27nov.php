										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="contain_data">
													...
													<p class="detail_item"><?php if($fac_details) echo $fac_details->fac_description;?></p>
												</div>
											</div>
										</div>
											<?php if($fac_details) { ?>
							...
							<div class="cus_modal profile_modal achievementlistwrapper">
								...
								<p class="detail_item"><?=$reward_detail->reward_title;?></p>
											...
											<a href="javascript:void(0)" class="delete_btn" ><span>Delete</span>
												<i class="fa fa-pencil-square-o"></i><input type="hidden" class="achivement_id_del" id="" value="<?=$reward_detail->reward_achievement_id;?>"></a>	
											</div>
										</div>
									</div>
