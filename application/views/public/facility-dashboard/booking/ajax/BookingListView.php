...
<tbody>
	...
	<tr>
				...
				<td class="text-center price_data_item">
					<a href="javascript:void(0)" data-toggle="modal" data-target="#bookingdetaillist" class="view_single_booking"><span class="participants red"><?=$list->booking_order_no;?></span><input type="hidden" id="order_id" value="<?=$list->booking_order_id;?>"></a>			
				</td>
