...
<ul>
<li>
<img src="<?=base_url('assets/public/images/cricket11.png')?>">
<input type="radio" name="sportname">
Cricket
</li>

<li>
<img src="<?=base_url('assets/public/images/tennis.png')?>">
<input type="radio" name="sportname">
Tennis
</li>

<li>
<img src="<?=base_url('assets/public/images/footbal.png')?>">
<input type="radio" name="sportname">
Football
</li>
</ul>
...
var cdf = bbb.split(month[n])[0];
    jQuery("#dateRange").append('<div class="item"><a href="javascript:void(0)"><div class="date_data"><input type="radio" name="rGroup" value="1" /><span class="week">'+ cdf +'</span><span class="day">'+ i +'</span> <span class="availableseat">5/7</span>          <i class="fa fa-calendar"></i><i class="fa fa-check-circle" aria-hidden="true"></i></div></a></div>');
...
/*		function calandardate(){
    ...
    var sport_id =$("#sportdetail option:selected" ).val();
 ...
 var ttt = month.findIndex(nextmonth);	
		...
		var ddd = jQuery("#yearname").text(); var mgh = jQuery(this).find(".day").text(); var cdf = mgh.split(" ");  var kkk = cdf[0];  var eee = ddd + "-" + (ttt + 1) + "-" + kkk; 
        alert(eee);
			var fac_id =$("#headeracademyfacility option:selected" ).val();
    		var sport_id =$("#sportdetail option:selected" ).val();
    		var fac_type =$("#headeracademyfacility option:selected" ).attr('fac_type');
...
$(document).on("click", '#slotscroll label', function(){ $(this).addClass('active'); $('.calandaruserdetail').show() });	
