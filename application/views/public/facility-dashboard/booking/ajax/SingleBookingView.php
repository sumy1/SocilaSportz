 						...
 						<div class="col-sm-12">
 							<div class="bookingroundcorner">
 								...
 								<div class="row">
 									...
 									<div class="col-sm-9"><?php if($order_main_detail) echo $order_main_detail->address;?></div>
 									<div class="col-sm-3 text-left"><strong>Sports</strong></div>
									<div class="col-sm-3"><strong>Date</strong></div>
									<div class="col-sm-3 text-right"><strong>Slot time</strong></div>
 									...
 									<?php foreach ($order_sub_detail as $order_sub_details) {
 										...
 										<div class="row sportslistbookingdetail">
 											...
 											<div class="col-sm-3 time"><?=$order_sub_details->batch_slot_start_time;?>-<?=$order_sub_details->batch_slot_end_time;?></div>
 										...
 										<div class="row  seprateborder">
 											...
 											<div class="col-sm-6 text-right nopadright ">Total: <span class="red"><i class="fa fa-inr"></i> <?php if($order_main_detail) echo $order_main_detail->total_amount;?></span> <br>
