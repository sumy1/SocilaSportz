<div class="content-wrapper content-wrapper--with-bg">
    ...
    <div id="create_event" class="container tab-pane active"><br>
      <div class="row rest_style">
       ...
       <div class="col-md-6">
        <div class="form-group bmd-form-group" style="margin-top:-6px;">
         <label for="Event Name" class="bmd-label-floating">Event Name</label>
     ...
     <div class="col-md-6">
      <div class="form-group bmd-form-group is-filled">
        <label for="Sport" class="bmd-label-floating " style="margin-left:30px"> Choose Sport</label>
      ...
      <div class="col-md-3">
        <div class="form-group bmd-form-group">
         <label for="start date" class="bmd-label-floating datepicker">Event Start Date</label>
     ...
     <div class="col-md-3">
      <div class="form-group bmd-form-group">
       <label for="end date" class="bmd-label-floating">Event End Date</label>
 ...
 <div class="col-md-3">
  <div class="form-group bmd-form-group">
   <label for="End date" class="bmd-label-floating">End Time</label>
...
<div class="col-md-3">
  <div class="form-group bmd-form-group">
   <label for="Enrollment Date" class="bmd-label-floating">Start Enrollment Date</label>
...
<div class="col-md-3">
  <div class="form-group bmd-form-group">
   <label for="Event Price" class="bmd-label-floating"> Event Price</label>
...
<div class="col-md-3">
  <div class="form-group bmd-form-group">
   ...
   <input type="text" class="form-control" name="Event_contact_person" id="Event_contact_person">
...
<div class="col-md-6">
  <div class="form-group bmd-form-group">
    ...
    <input type="text" class="form-control" id="Event_contact_person_email" name="Event_contact_person_email">
...
<div class="col-md-4">
 <div class="form-group bmd-form-group is-filled">
  <label for="event rule" class="bmd-label-floating">Event Rule</label>
  <textarea id="event_eligibility" name="event_eligibility"></textarea>
...
<div class="col-md-6">
 <ul class="list-inline top_btns_action">
  <li class="list-inline-item">
                  ...
                  <a href="javascript:void(0)" class="btn btn-raised btn-sm filter_btn" id="clearbtn"><i class="fa fa-refresh"></i> Clear<div class="ripple-container"></div><div class="ripple-container"></div></a>
                </li>
  <li class="list-inline-item">
