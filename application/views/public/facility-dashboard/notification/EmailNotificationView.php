						...
						<div class="main_container_dashboard">
							<div class="row">
								...
								<div class="col-md-6">
									...
									<a href="javascript:void(0)" class="btn btn-raised btn-sm filter_btn clearbtnnotification" id="clearbtn"><i class="fa fa-refresh"></i> Clear<div class="ripple-container"></div></a>
								</li>
										<li class="list-inline-item">
...
$('.datepicker').dateDropper();
		...
		$(document).ready(function(){
			setTimeout(function(){
				...
				$.ajax({
					type: "POST",
                    //async: true,
                    url:'<?php echo base_url();?>facility/notification/email_notification_list',    
				...
				$.ajax({
					type: "POST",
                    //async: true,
                    url:'<?php echo base_url();?>facility/notification/email_notification_count',    
                    data: {fac_id:fac_id},
                    success:function(res){
		...
		$('.clearbtnnotification').on('click', function(e) {
  var fac_id =$("#headeracademyfacility option:selected" ).val();
  $.ajax({
    type: "POST",
      //async: true,
