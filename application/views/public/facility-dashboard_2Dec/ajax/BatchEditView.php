...
$.ajax({
    ...
    type: 'POST',
    data: {action:action,fac_id,fac_id,sport_id:sport_id,start_date:start_date,end_date:end_date,start_time:start_time,end_time:end_time,package_price:package_price,packages_id:packages_id,max_participanets:max_participanets,week_days:week_days,batch_slot_id:batch_slot_id,is_trial:is_trial,fac_batch_slot_status:fac_batch_slot_status},
