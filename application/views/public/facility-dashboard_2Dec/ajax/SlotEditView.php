                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group bmd-form-group">
                            <label for="StartDate" class="bmd-label-floating datepicker">Start Enrollment Date<span class="required">*</span></label>
                            <input type="text"  data-format="d-m-Y"  class="form-control datepicker" id="slotstartdate1" data-large-mode="true" data-large-default="true" value="<?php if($slot_details) echo date('d-m-Y',strtotime($slot_details->start_date));?>">
                    ...
                    <div class="col-md-2">
                        <div class="form-group bmd-form-group">
                            <label for="EndDate" class="bmd-label-floating datepicker">End Enrollment Date<span class="required">*</span></label>
                            <input type="text" data-format="d-m-Y" class="form-control datepicker" id="slotenddate1" data-large-mode="true" data-large-default="true"  value="<?php if($slot_details) echo date('d-m-Y',strtotime($slot_details->end_date));?>">
                            <i class="fa fa-calendar prefix" aria-hidden="true"></i>
...
//alert(week_days);
                ...
                type: 'POST',
                data: {action:action,fac_id,fac_id,sport_id:sport_id,batch_slot_type_id:batch_slot_type_id,start_date:start_date,end_date:end_date,start_time:start_time,end_time:end_time,slotprice:slotprice,max_participanets:max_participanets,week_days:week_days,batch_slot_id:batch_slot_id,court_type:court_type,court_desc:court_desc,kit_price:kit_price,fac_batch_slot_status:fac_batch_slot_status,sl_kit_checked:sl_kit_checked},
