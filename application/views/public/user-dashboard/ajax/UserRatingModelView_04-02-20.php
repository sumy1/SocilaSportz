  ...
  <div class="modal-content">
            ...
            <div class="form-group row align-items-center mb-2">
			  ...
			  <input type="hidden" name="rating_id" value="<?=$user_rating_edit->rating_id;?>" id="rating_id">
                ...
                <div class="rate rating-2">
				 ...
				 <li class="list-inline-item <?php if($user_rating_edit->rating >0) echo "active"  ?>"><i class="fa fa-star"></i></li>
                      <li class="list-inline-item <?php if($user_rating_edit->rating >1) echo "active"  ?>"><i class="fa fa-star"></i></li>
                      <li class="list-inline-item <?php if($user_rating_edit->rating >2) echo "active"  ?>"><i class="fa fa-star"></i></li>
                      <li class="list-inline-item <?php if($user_rating_edit->rating >3) echo "active"  ?>"><i class="fa fa-star"></i></li>
                      <li class="list-inline-item <?php if($user_rating_edit->rating >4) echo "active"  ?>"><i class="fa fa-star"></i></li>
	...
	$(document).ready(function(){
	 ...
	 $('#reviewactionss').on("click", function(){
	   var rating=$('.rating-2').find('li.active').length;
