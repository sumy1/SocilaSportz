									...
									<div class="col-sm-4"><strong>Date</strong></div>
 									...
 									<div class="col-sm-2"><strong>Price</strong></div>
 										...
 										<div class="row  seprateborder">
 											<div class="col-sm-8 text-left nopadleft">Booking Mode: <span class="green"></span><?php echo $old_booking_deatail[0]->booking_type; ?></div>
 											<div class="col-sm-4 text-right nopadright " style=""><span style="color: #292828;    font-weight: normal;">Total Amount:</span> <span class="red"><i class="fa fa-inr"></i><?php if($old_booking_deatail) echo $old_booking_deatail[0]->total_amount;?>  </span>
